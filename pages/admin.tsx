...
import {currScoutingType} from "./api/getstats";
...
const Data: NextPage = () => {
  ...
  const [stats, setSats] = useState({"currScouting": [], "scouting": []});
  /**
   * Export match data
   */
          ...
          stats["currScouting"].map((element: currScoutingType) => {
            ...
            return (
              <article key={element.stationId}>
                ...
                {element.scouting ?
                  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 64 64"><circle cx="32" cy="32" r="30" fill="#4bd37b"/><path fill="#fff" d="M46 14L25 35.6l-7-7.2l-7 7.2L25 50l28-28.8z"/></svg> :
                  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="red" d="M10 1c-5 0-9 4-9 9s4 9 9 9s9-4 9-9s-4-9-9-9zm0 16c-3.9 0-7-3.1-7-7s3.1-7 7-7s7 3.1 7 7s-3.1 7-7 7zM6 9v2h8V9H6z" className="st0"/></svg>
                }
              </article>
            );
          })
